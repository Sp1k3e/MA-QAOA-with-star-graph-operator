...
plt.bar(offsets[1], QAOA_variational_lambda_feasible, width, label='QAOA_variational_lambda')
plt.bar(offsets[2], QAOA_variational_lambdas_feasible, width, label='QAOA_variational_lambdas')
plt.bar(offsets[3], QAOA_additional_RX_feasible, width, label='QAOA_additional_RX')
...
plt.bar(offsets[1], QAOA_variational_lambda_optimal, width, label='QAOA_variational_lambda')
plt.bar(offsets[2], QAOA_variational_lambdas_optimal, width, label='QAOA_variational_lambdas')
plt.bar(offsets[3], QAOA_additional_RX_optimal, width, label='QAOA_additional_RX')
